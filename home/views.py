...
from .forms import PostCreateUpdataForm, CommentCreateForm, CommentReplyForm, PostSearchForm
...
class PostDetailView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_comment.save()
            messages.success(request, 'you comment submited', 'success')
...
class PostUpdateView(LoginRequiredMixin, View):
    form_class = PostCreateUpdataForm
